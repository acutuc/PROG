 ...
 * @author acutuc
 */
public class EjercicioMetodosBanco {

    private static boolean filtroEdad(int edad) {
        boolean filtroEdad;
        if (edad < 65 && edad > 18) {
            filtroEdad = false;
        } else {
    ...
    public static void main(String[] args) {
        ...
        // 1. Método que recibe edad, devuelve boolean (return).
        // 2. Método que recibe dineroPedir, sueldo, FACTOR_MULTIPLICATIVO, devuelve boolean (return).
        // 3. Método que recibe años y edad, devuelve boolean (return).
        ...
        //Inicializo variables constantes que utilizaré durante el ejercicio.
        ...
        la multiplico por el factor multiplicativo.*/
            ...
            double factorMultiplicativo = sueldoBrutoAnual * FACTOR_MULTIPLICATIVO;
